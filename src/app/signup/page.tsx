    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--color-cream)' }}>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm" style={{ color: 'var(--color-text-body)' }}>Create your account</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input name="first_name" type="text" required className="cp-input" placeholder="Jane" />
              </div>
              <div>
                <label className="block text-sm font-medium mb-1" style={{ color: 'var(--color-brown)' }}>
                  Last name
                </label>
                <input name="last_name" type="text" required className="cp-input" placeholder="Smith" />
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium mb-1" style={{ color: 'var(--color-brown)' }}>
            ...
            <div>
              ...
              <input name="password" type="password" required minLength={8} className="cp-input" placeholder="Min. 8 characters" />
            </div>
